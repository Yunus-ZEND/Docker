FROM ubuntu:groovy
LABEL maintainer "Zora24 <liualvinas24@gmail.com>"
...
RUN pip3 install --no-cache-dir -r https://raw.githubusercontent.com/X-Newbie/XBot-Remix/sql-extended/requirements.txt --use-feature=2020-resolver
